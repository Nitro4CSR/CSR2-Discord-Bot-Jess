...
class VisionCommandCog(commands.Cog):
    ...
    async def vison_command(self, interaction: discord.Interaction, car: str = None, rarity: app_commands.Choice[str] = None, tier: app_commands.Choice[str] = None, csr2_version: str = None):
